export default {
  ...
  getLeftSidebarItem1(state) {
    return state.leftSidebarItem_1;
  },
  getLeftSidebarItem2(state) {
    return state.leftSidebarItem_2;
  },
  getLeftSidebarItem3(state) {
    return state.leftSidebarItem_3;
  },
  getLeftSidebarItem4(state) {
    return state.leftSidebarItem_4;
  },
  getLeftSidebarItem5(state) {
    return state.leftSidebarItem_5;
  },
  getLeftSidebarItem6(state) {
    return state.leftSidebarItem_6;
  },
  getLeftSidebarItem7(state) {
    return state.leftSidebarItem_7;
  },
  getLeftSidebarItem8(state) {
    return state.leftSidebarItem_8;
  },
  getLeftSidebarItem9(state) {
    return state.leftSidebarItem_9;
  },
  getLeftSidebarItem10(state) {
    return state.leftSidebarItem_10;
  },
  getLeftSidebarItem11(state) {
    return state.leftSidebarItem_11;
  },
  getLeftSidebarItem12(state) {
    return state.leftSidebarItem_12;
  },
  getLeftSidebarItem13(state) {
    return state.leftSidebarItem_13;
  },
  getLeftSidebarItem14(state) {
    return state.leftSidebarItem_14;
  },
};
